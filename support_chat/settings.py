...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv("DB_NAME", "mychatdb_bthk"),
        'USER': os.getenv("DB_USER", "mychatdb_bthk_user"),
        'PASSWORD': os.getenv("DB_PASSWORD", "JEzRcrQhjLuo0uPaMd06kwSdCaZeuUwk"),
        'HOST': os.getenv("DB_HOST", "dpg-d3drccggjchc73aq1gl0-a.render.com"),
